...
def process_song_file(cur, filepath):
    """
    - Opens song file located in `filepath`    
    - Inserts song record    
...
def main():
    ...
    cursor to it.    
    - Performs ETL on song data to create songs and artists dimensional tables.  
    - Performs ETL on log data to create time and users dimensional tables, as well as the songplays fact table.
